<html><body>
<div style="min-width:620px;width:100%;box-sizing:border-box;padding:20px 0;background-color:transparent;background-image:none">
                                                                ...
                                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:15px;width:600px">
                                                                            ...
                                                                            <p></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">User '. $first .' '. $last .'  checked on April 12 2022:</p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Are you pregnant, or do you plan to become pregnant in the next 12 months? : '.$are_you_pregnant.</p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Are you breastfeeding, pregnant, or planning to become pregnant within the next 12 months? : '.$are_you_pregnant.</p>
