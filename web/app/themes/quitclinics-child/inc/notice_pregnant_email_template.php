...
function  get_notice_pregnant_email_template ($args) {

    $data  = $args;
    $message = '<html><body>';
    $message .='<div style="min-width:620px;width:100%;box-sizing:border-box;padding:20px 0;background-color:transparent;background-image:none">
        ...
        <tr>
            <td valign="top" width="100%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;background-repeat:no-repeat;background-size:cover;background-position:top;padding:25px 35px;background-image:none;background-color:#ffffff;border-width:0px;border-radius:0px;border-color:#444444;width:600px">
                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:collapse;margin:0;padding:0">
                    <tbody>
                    <tr>
                        <td valign="top" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border-collapse:collapse;margin:0;padding:0;font-size:0">
                            <table align="left" width="50%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:0;padding:0;border-collapse:collapse">
                                <tbody>
                                <tr>
                                                                ...
                                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:15px;width:265px;text-align:start;padding:0px;background-image:none">
                                                                            <img width="140" src="https://www.quitclinics.com/app/uploads/2020/12/logo-client-logo.png" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;background-color:transparent;max-width:100%;vertical-align:middle;width:140px">
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                            ...
                                                                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate;margin:0;padding:0">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" width="33.333333333333%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                        <a href="https://www.quitclinics.com/how-it-works/" style="text-decoration:none;color:#332ce6;font-weight:600;font-style:inherit" target="_blank">
                                                                                            How it Works                                </a>
                                                                                    </td>
                                                                                    <td valign="top" width="33.333333333333%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                        <a href="https://www.quitclinics.com/help-advice/" style="text-decoration:none;color:#332ce6;font-weight:600;font-style:inherit" target="_blank">
                                                                                            Help &amp; Advice                                </a>
                                                                                    </td>
                                                                                    <td valign="top" width="33.333333333333%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                        <a href="https://www.quitclinics.com/knowledge/" style="text-decoration:none;color:#332ce6;font-weight:600;font-style:inherit" target="_blank">
                                                                                            Knowledge                                </a>
                                                                                    </td>
                                                                                </tr>
                                                                                </tbody>
        ...
        <tr>
            <td valign="top" width="100%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;background-repeat:no-repeat;background-size:cover;background-position:top;padding:0px;background-image:none;background-color:#ffffff;border-width:0px;border-radius:0px;border-color:#444444;width:600px">
                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:collapse;margin:0;padding:0">
                    ...
                    <tr>
                        <td valign="top" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%;font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;border-collapse:collapse;margin:0;padding:0;font-size:0">
                            <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:0;padding:0;border-collapse:collapse">
                                <tbody>
                                <tr>
                                    <td style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                        <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:0;padding:0;border-collapse:collapse;width:100%">
                                                                ...
                                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate">
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:15px;width:600px">
                                                                            ...
                                                                            <p></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">User '. $data["first"] .' '. $data["last"] .'  checked on '.$data["date"].':</p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">User email <a href="mailto:'. $data["email"] .'" style="text-decoration: none;color: #332ce6;font-weight: 600;font-style: inherit;">'. $data["email"] .'</a></p>
                                                                            <p style="display:block;margin:0;font-size:17px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:15px;margin-bottom:5px;text-align:left;padding:0 35px"><strong>Medical History Questionnaire:</strong></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Have you had a stroke, heart attack, irregular heartbeat, uncontrolled hypertension or angina in the past month?
 : <strong>'.$data["has_heart_attack_renewal"].'</strong></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Are you pregnant, or do you plan to become pregnant in the next 12 months? : <strong>'.$data["are_you_pregnant_renewal"].'</strong></p>
                                                                            <p style="display:block;margin:0;font-size:17px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:15px;margin-bottom:5px;text-align:left;padding:0 35px"><strong>Initial Questionnaire:</strong></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Have you had a stroke, heart attack, irregular heartbeat, uncontrolled hypertension or angina in the past month? : <strong>'.$data["has_heart_attack_initial"].'</strong></p>
                                                                            <p style="display:block;margin:0;font-size:15px;font-weight:400;line-height:22px;color:#444444;background-color:transparent;margin-top:25px;margin-bottom:25px;text-align:left;padding:0 35px">Are you breastfeeding, pregnant, or planning to become pregnant within the next 12 months? : <strong>'.$data["are_you_pregnant_initial"].'</strong></p>
                                                                            ...
                                                                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate;margin:0;padding:0">
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" width="50%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                        <a href="https://www.quitclinics.com/terms-conditions/" style="text-decoration:none;color:#332ce6;font-weight:400;font-style:inherit" target="_blank">
                                                                                            Terms &amp; Conditions                                </a>
                                                                                    </td>
                                                                                    <td valign="top" width="50%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                        <a href="https://www.quitclinics.com/privacy-policy/" style="text-decoration:none;color:#332ce6;font-weight:400;font-style:inherit" target="_blank">
                                                                                ...
                                                                                <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-collapse:separate;margin:0;padding:0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td valign="top" width="100%" style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
                                                                                            <a href="https://www.quitclinics.com/" style="text-decoration:none;color:#332ce6;font-weight:400;font-style:inherit" target="_blank">
                                                                                                Quitclinics                                </a>
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody>
