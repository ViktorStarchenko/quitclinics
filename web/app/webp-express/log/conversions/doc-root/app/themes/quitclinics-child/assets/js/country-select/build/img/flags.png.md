WebP Express 0.19.0. Conversion triggered using bulk conversion, 2021-04-08 13:07:38
...
Destination folder does not exist. Creating folder: [doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/js/country-select/build/img

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png
- destination: [doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png.webp
...
Executing command: nice convert -quality '85' -strip -define webp:alpha-quality=85 -define webp:method=6 '[doc-root]/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png' 'webp:[doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png.webp.lossy.webp' 2>&1
success
Reduction: 50% (went from 64 kb to 32 kb)

Converting to lossless
Version: ImageMagick 7.0.8-42 Q16 x86_64 2019-04-24 https://imagemagick.org
using nice
Executing command: nice convert -quality '85' -define webp:lossless=true -strip -define webp:alpha-quality=85 -define webp:method=6 '[doc-root]/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png' 'webp:[doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/js/country-select/build/img/flags.png.webp.lossless.webp' 2>&1
success
Reduction: 20% (went from 64 kb to 51 kb)

Picking lossy
imagemagick succeeded :)

Converted image in 2016 ms, reducing file size with 50% (went from 64 kb to 32 kb)
