WebP Express 0.19.0. Conversion triggered using bulk conversion, 2021-04-08 13:07:34
...
Destination folder does not exist. Creating folder: [doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/images/icons

Options:
------------
The following options have been set explicitly. Note: it is the resulting options after merging down the "jpeg" and "png" options and any converter-prefixed options.
- source: [doc-root]/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png
- destination: [doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png.webp
...
Executing command: nice convert -quality '85' -strip -define webp:alpha-quality=85 -define webp:method=6 '[doc-root]/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png' 'webp:[doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png.webp.lossy.webp' 2>&1
success
Reduction: 22% (went from 5589 bytes to 4332 bytes)

Converting to lossless
Version: ImageMagick 7.0.8-42 Q16 x86_64 2019-04-24 https://imagemagick.org
using nice
Executing command: nice convert -quality '85' -define webp:lossless=true -strip -define webp:alpha-quality=85 -define webp:method=6 '[doc-root]/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png' 'webp:[doc-root]/app/webp-express/webp-images/doc-root/app/themes/quitclinics-child/assets/images/icons/User-Interface-Login-icon.png.webp.lossless.webp' 2>&1
success
Reduction: 84% (went from 5589 bytes to 876 bytes)

Picking lossless
imagemagick succeeded :)

Converted image in 847 ms, reducing file size with 84% (went from 5589 bytes to 876 bytes)
