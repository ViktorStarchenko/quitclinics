    ...
    $(".go_to_login_link").click(function(e) {
        if (jsPassData.type_modal != 'LinkToDefault') {
            ...
            if ($("#csh-login-wrap").css("display") == "none") {
                ...
                } else if (jsPassData.type_modal == 'SideMenu') {
                    $("#csh-login-wrap").css('position', 'fixed');
                    $("#csh-login-wrap").css('top', '0');
                    $("#csh-login-wrap").css('right', '0');
                }

                if ($("#csh-login-wrap").hasClass( "SideMenu" )) {
                    $("#csh-login-wrap").animate({width: 'toggle'});
                } else {
