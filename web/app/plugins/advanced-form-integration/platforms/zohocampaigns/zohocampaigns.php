                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="adfoin_zohocampaigns_client_id"
                               value="<?php echo $client_id; ?>" placeholder="<?php _e( 'Enter Client ID', 'advanced-form-integration' ); ?>"
                               class="regular-text"/>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="adfoin_zohocampaigns_client_secret"
                               value="<?php echo $client_secret; ?>" placeholder="<?php _e( 'Enter Client Secret', 'advanced-form-integration' ); ?>"
                               class="regular-text"/>
                    </td>
                </tr>
