...
function adfoin_mailify_settings_view( $current_tab ) {
    ...
    <form name="mailify_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"> <?php _e( 'Account Number', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_mailify_account_number"
                           value="<?php echo $account_number; ?>" placeholder="<?php _e( 'Enter Account Number', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row"> <?php _e( 'Key', 'advanced-form-integration' ); ?></th>
                <td>
                    <input type="text" name="adfoin_mailify_key"
                           value="<?php echo $key; ?>" placeholder="<?php _e( 'Enter Key', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Settings > Developer', 'advanced-form-integration' ); ?></p>
                </td>
...
add_action( 'admin_post_adfoin_save_mailify_api_key', 'adfoin_save_mailify_api_key', 10, 0 );
