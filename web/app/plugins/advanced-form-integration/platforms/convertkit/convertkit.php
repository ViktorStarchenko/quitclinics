...
function adfoin_convertkit_settings_view( $current_tab )
{
    ...
    <form name="convertkit_save_form" action="<?php 
    ...
    _e( 'Please go to Account Settings to get API Key', 'advanced-form-integration' );
    ?></a></p>
                </td>
            </tr>
        </table>
    ...
    ?>
            ...
            <tr valign="top" class="alternate" v-if="action.task == 'subscribe'">
                <td scope="row-title">
                    <label for="tablecell">
                        <?php 
    esc_attr_e( 'ConvertKit Sequence', 'advanced-form-integration' );
    ?>
                    </label>
                </td>
                <td>
 ...
 */
function adfoin_convertkit_save_integration()
{
    $params = array();
