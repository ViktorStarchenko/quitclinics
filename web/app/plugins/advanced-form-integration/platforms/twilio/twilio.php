            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_twilio_account_sid"
                           value="<?php echo $account_sid; ?>" placeholder="<?php _e( 'Please enter ACCOUNT SID', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_twilio_auth_token"
                           value="<?php echo $auth_token; ?>" placeholder="<?php _e( 'Please enter AUTH TOKEN', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
        </table>
