...
function adfoin_emailoctopus_settings_view( $current_tab ) {
    ...
    <form name="emailoctopus_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"> <?php _e( 'EmailOctopus API Key', 'advanced-form-integration' ); ?></th>
                <td>
...
function adfoin_get_emailoctopus_list() {
    ...
    $url = "https://emailoctopus.com/api/1.5/lists?api_key=" . $api_key;
 ...
 */
function adfoin_emailoctopus_save_integration() {
    $params = array();
...
function adfoin_emailoctopus_send_data( $record, $posted_data ) {
    ...
    if( $task == "subscribe" ) {
        ...
        $sub_url = "https://emailoctopus.com/api/1.5/lists/{$list_id}/contacts";
