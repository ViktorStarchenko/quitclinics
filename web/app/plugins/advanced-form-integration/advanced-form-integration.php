...
class Advanced_Form_Integration
{
    ...
    public function includes()
    {
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/autopilot/autopilot.php';
        ...
        //        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/constantcontact/constantcontact.php';
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/hubspot/hubspot.php';
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/pabbly/pabbly.php';
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/sendpulse/sendpulse.php';
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/sendy/sendy.php';
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/smartsheet/smartsheet.php';
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/trello/trello.php';
