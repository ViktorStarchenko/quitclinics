...
echo  json_encode( $integration_title, true ) ;
?> ;
</script>
...
<div class="wrap">
    ...
    <h1> <?php 
esc_attr_e( 'New Integration', 'advanced-form-integration' );
?></h1>
...
?>" method="post" id="new-integration" >
...
?> </option>
                ...
                <div>
                    <p>
                        <input class="button-primary" type="submit" name="save_integration" value="<?php 
esc_attr_e( 'Save Integration', 'advanced-form-integration' );
?>" />
