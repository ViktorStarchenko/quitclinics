 ...
 * Description: WooCommerce eWAY Rapid 3.1 payment gateway integration supporting AU, NZ, SG, MY, and HK. Support for WooCommerce Subscriptions.
...
define( 'WOOCOMMERCE_GATEWAY_EWAY_VERSION', '3.1.25' ); // WRCS: DEFINED_VERSION.
